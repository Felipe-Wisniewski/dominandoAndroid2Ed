...
public class UtilHttp {
    ...
    public static void enviarFoto(Context ctx, String titulo, String path) throws Exception{
        ...
        final String urlDoServidor = "http://192.168.0.15/upload_foto/upload_file.php";
        ...
        try {
            ...
            conexao.setRequestProperty("Content-Type", "multipart/form-data;boundary=" + delimitador);
            conexao.connect();
            ...
            outputStream.writeBytes("Content-Disposition: form-data; " +
                                "name=\"arquivo\";filename=\"" + caminhoDoArquivoNoDispositivo +
                                "\"" + fimDeLinha);
            outputStream.writeBytes(fimDeLinha);
            ...
            //lendo arquivo e escrevendo na conexao
            ...
            if (serverResponseCode != HttpURLConnection.HTTP_OK){
                Log.d("FLMWG", serverResponseCode + " = " + serverResponseMessage);
                throw new RuntimeException("Error " + serverResponseCode + ": " + serverResponseMessage);
            }
        }finally {
