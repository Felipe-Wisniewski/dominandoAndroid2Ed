...
public class HotelProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "dominando.android.provider";
    ...
    public String getType(Uri uri) {
        ...
        switch (uriType){
            case TIPO_GERAL:
                return "vnd.android.cursor.dir/dominando.android.provider";

            case TIPO_HOTEL_ESPECIFICO:
                return "vnd.android.cursor.item/dominando.android.provider";
        }
        return null;
    }
