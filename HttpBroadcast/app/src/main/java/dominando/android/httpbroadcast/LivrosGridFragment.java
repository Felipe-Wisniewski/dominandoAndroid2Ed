...
public class LivrosGridFragment extends InternetFragment implements Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mProgressBar = layout.findViewById(R.id.progressBar_flg);
        mTextMensagem = layout.findViewById(R.id.empty_flg);
        mGridView = layout.findViewById(R.id.gridView_flg);
