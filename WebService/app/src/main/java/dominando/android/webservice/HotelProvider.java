...
public class HotelProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "dominando.android.webservice";
    ...
    public String getType(Uri uri) {
        ...
        switch (uriType){
            case TIPO_GERAL:
                return "vnd.android.cursor.dir/dominando.android.webservice";

            case TIPO_HOTEL_ESPECIFICO:
                return "vnd.android.cursor.item/dominando.android.webservice";
        }
        return null;
    }
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriType){
            case TIPO_GERAL:
                linhasAfetadas = sqlDB.update(HotelSQLHelper.TABELA_HOTEL, values, selection, selectionArgs);
                break;
